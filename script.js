...
// MY-COMMENT || `const` variables are read and use only and cannot be reassigned.
const SCHOOL = "MyCollege";
...
// MY-COMMENT || When one operand is a string the plus operaton does string concatenation after coercing the other operand to a string.
console.log('"2" + 3 =', "2" + 3);
console.log('2 + "3" =', 2 + "3");
console.log("2 + 3 =", 2 + 3);
...
console.log("Sum integers 1..10 =", total);
